...
Assumeutxo is a feature that allows fast bootstrapping of a validating rubasd
...
considered active. This is the "traditional" mode of operation for rubasd.
...
**Failure consideration:** if rubasd unexpectedly halts after `m_stop_use` is set on
...
### Rubasd restarts sometime after snapshot validation has completed

When rubasd initializes again, what began as the snapshot chainstate is now
