...
Version 2 of the Rubas P2P protocol / BIP324, which enables encryption of the P2P protocol,
has been enabled by default in this version. This was initially introduced in Rubas Core
...
You can view [the list of bad ports here](https://github.com/rubaspay/rubas/blob/v22.1.x/doc/p2p-bad-ports.md).

Tests
-----

- Command line arguments `-dip8params` and `-bip147height` are removed in favor of `-testactivationheight`. (rubas#6325)
...
- The top-level fee fields `fee`, `modifiedfee`, `ancestorfees` and `descendantfees`
  ...
  fields in the `fees` object are denominated in RUBAS.
...
- Improved GUI responsiveness for large wallets. (rubas#6457)
...
- [v22.0.0](https://github.com/rubaspay/rubas/blob/master/doc/release-notes/rubas/release-notes-22.0.0.md) released Dec/12/2024
...
[set-of-changes]: https://github.com/rubaspay/rubas/compare/v22.0.0...rubaspay:v22.1.0
