# Support for Output Descriptors in Rubas Core

Since Rubas Core v0.17, there is support for Output Descriptors. This is a
...
existing Rubas Core wallets, a convenience function `combo` is
...
All RPCs in Rubas Core will include the checksum in their output. Only
