...
This mechanism has been integrated into Bitcore-Node-Rubas which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rubaspay/insight-api-rubas#web-socket-api](https://github.com/rubaspay/insight-api-rubas#web-socket-api)
* API: [https://github.com/rubaspay/insight-api-rubas#instantsend-transactions](https://github.com/rubaspay/insight-api-rubas#instantsend-transactions)
