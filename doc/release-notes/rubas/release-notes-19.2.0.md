...
At the first startup Rubas Core will run a migration process which can take
...
incompatible with older versions of Rubas Core, so a db migration path was
...
See detailed [set of changes](https://github.com/rubaspay/rubas/compare/v19.1.0...rubaspay:v19.2.0).
