...
- `wipetxes`: New command for `rubas-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/rubaspay/rubas/compare/v19.2.0...rubaspay:v19.3.0).
