...
provided in [DIP-0020](https://github.com/rubaspay/dips/blob/master/dip-0020.md).
...
from other quorum members. This allows Rubas Platform to obtain required
...
provided in [DIP-0021](https://github.com/rubaspay/dips/blob/master/dip-0021.md).

Platform support
----------------
Support for Rubas Platform has been expanded through the addition of a new
...
BLS update
----------
Rubas Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of RubasCore. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of Rubas Core includes multiple optimizations to the network and
p2p message handling code.

We reintroduced [Intra-Quorum Connections](https://github.com/rubaspay/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in RubasCore v0.16
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/rubaspay/rubas/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are Rubas specific and seven new RPC
...
will be removed in RubasCore v0.18. Note that the deprecation of wallet accounts
...
Rubas users. Bitcoin changes that do not align with Rubas’s product needs, such
...
See detailed [set of changes](https://github.com/rubaspay/rubas/compare/v0.16.1.1...rubaspay:v0.17.0.2).
