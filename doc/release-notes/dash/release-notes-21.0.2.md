...
Resolved a bug that prevented some clients (incl. Rubas mobile wallets) from receiving transactions before they are mined
...
The [docker images](https://hub.docker.com/r/rubaspay/rubasd) should now provide SBOM and provenance.
...
[set-of-changes]: https://github.com/rubaspay/rubas/compare/v21.0.0...rubaspay:v21.0.2
