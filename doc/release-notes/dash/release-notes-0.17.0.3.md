...
See detailed [set of changes](https://github.com/rubaspay/rubas/compare/v0.17.0.2...rubaspay:v0.17.0.3).

- [`6a54af0df7`](https://github.com/rubaspay/rubas/commit/6a54af0df7) Bump to v0.17.0.3
- [`97e8461234`](https://github.com/rubaspay/rubas/commit/97e8461234) doc: Archive v0.17.0.2 release notes
- [`96c041896b`](https://github.com/rubaspay/rubas/commit/96c041896b) feat: add tor entrypoint script for use in rubasmate (#4182)
- [`3661f36bbd`](https://github.com/rubaspay/rubas/commit/3661f36bbd) Merge #14416: Fix OSX dmg issue (10.12 to 10.14) (#4177)
- [`4f4bda0557`](https://github.com/rubaspay/rubas/commit/4f4bda0557) depends: Undefine `BLSALLOC_SODIUM` in `bls-rubas.mk` (#4176)
- [`575e0a3070`](https://github.com/rubaspay/rubas/commit/575e0a3070) qt: Add `QFont::Normal` as a supported font weight when no other font weights were found (#4175)
- [`ce4a73b790`](https://github.com/rubaspay/rubas/commit/ce4a73b790) rpc: Fix `upgradetohd` help text (#4170)
- [`2fa8ddf160`](https://github.com/rubaspay/rubas/commit/2fa8ddf160) Translations 202105 (add missing) (#4169)
