...
- Core now categorizes asset unlock transactions as "Platform Transfers" on the Transactions tab in Rubas-Qt and in the output of the `gettransaction` RPC (#6131)
- Persist Coinjoin Denoms options changes made via GUI over restarts (#6208)
- Fix incorrect payment predictions for evonodes in Rubas-Qt and in RPC `masternode winners` (#6222)
...
[set-of-changes]: https://github.com/rubaspay/rubas/compare/v21.1.0...rubaspay:v21.1.1
