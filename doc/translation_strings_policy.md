...
This document provides guidelines for internationalization of the Rubas Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rubas_en.ts` remains unchanged.
