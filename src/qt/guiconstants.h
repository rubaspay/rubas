...
/* RubasGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* RubasGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Rubas"
#define QAPP_ORG_DOMAIN "rubas.org"
#define QAPP_APP_NAME_DEFAULT "Rubas-Qt"
#define QAPP_APP_NAME_TESTNET "Rubas-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Rubas-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Rubas-Qt-regtest"
