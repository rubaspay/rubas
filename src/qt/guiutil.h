...
/** Utility functions used by the Rubas Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "rubas:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load rubas specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a rubas specific theme is activated (light/dark).*/
