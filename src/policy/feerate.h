...
const std::string CURRENCY_UNIT = "RUBAS"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    RUBAS_KB,      //!< Use RUBAS/kB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::RUBAS_KB) const;
