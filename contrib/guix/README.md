...
This directory contains the files necessary to perform bootstrappable Rubas
Core builds.
...
To build Rubas Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Rubas Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/rubas-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/rubaspay/guix.sigs).
