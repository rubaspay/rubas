Contributing to Rubas Core
============================

The Rubas Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Rubas Core
...
Before you start contributing, familiarize yourself with the Rubas Core build
system and tests. Refer to the documentation in the repository on how to build
Rubas Core and how to run the unit and functional tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/rubaspay/rubas/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
Most communication about Rubas Core development happens on Discord Server.
...
fork of Rubas Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/rubaspay/rubas/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Rubas Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Rubas
Network Protocol consensus changes.

Whether a pull request is merged into Rubas Core rests with the project merge
...
Patches that change Rubas consensus rules are considerably more involved than
...
Where a patch set proposes to change the Rubas consensus, it must have been
...
The review process is normally fairly responsive on the Rubas Core repository, however
...
Bitcoin Backports are an incredibly valuable part of Rubas's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for Rubas](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
