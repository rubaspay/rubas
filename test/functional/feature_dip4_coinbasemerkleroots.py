...
class LLMQCoinbaseCommitmentsTest(RubasTestFramework):
    def set_test_params(self):
        ...
        self.set_rubas_test_params(4, 3, extra_args = self.extra_args)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as RubasTestFramework doesn't support this atm)
