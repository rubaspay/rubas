...
"""Verify that starting rubasd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rubasd with -h for help text")
        ...
        self.log.info("Start rubasd with -version for version information")
        ...
        self.log.info("Start rubasdd with -fakearg to make sure it does not start")
